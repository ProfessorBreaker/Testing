...
let namesByParkingSpace = [13: "Alice", 27: "Bob"]
//let space13Assignee: String? = namesByParkingSpace[13]
let space42Assignee: String? = namesByParkingSpace[42]

if let space13Assignee: String = namesByParkingSpace[13] {
...
for (space, name) in namesByParkingSpace {
